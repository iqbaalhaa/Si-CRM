...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('reports.settings.save') }}" method="POST" class="mb-4">
                @csrf
                <div class="mb-2">
                ...
                <div class="d-flex justify-content-end mt-3">
                    <button class="btn btn-primary" type="submit">Simpan Template Karyawan</button>
                </div>
            </form>
            ...
            <form action="{{ route('reports.settings.save') }}" method="POST">
                ...
                @enderror
                <div class="d-flex justify-content-end mt-3">
                    <button class="btn btn-secondary" type="submit">Simpan Template Customers</button>
                </div>
            </form>
        </div>
    </div>
