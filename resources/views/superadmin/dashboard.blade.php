                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="role-row">
                                    ...
                                    <div class="role-bar">
                                        <div class="role-bar-fill role-superadmin"
                                            style="width: {{ ($totalSuperAdmin / $roleTotal) * 100 }}%"></div>
                                    </div>
                                ...
                                <div class="role-row">
                                    ...
                                    <div class="role-bar">
                                        <div class="role-bar-fill role-admin"
                                            style="width: {{ ($totalAdmin / $roleTotal) * 100 }}%"></div>
                                    </div>
